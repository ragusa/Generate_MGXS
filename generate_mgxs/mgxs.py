...
def load_mgxs(path, logical_domain: str, temperature_k: float = 294.0, *, uncertainty_path=None) -> MGXS:
    ...
    return MGXS(
        bounds, total, absorption, scatter, logical_domain, float(temperature_k),
        chi_raw=chi_raw, chi=chi, chi_raw_sum=chi_sum,
        chi_normalization_factor=chi_factor, chi_closure_correction=chi_correction,
